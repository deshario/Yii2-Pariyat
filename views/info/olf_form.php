        ...
        <div class="box-body">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4"><?= $form->field($model, 'std_profile')->textInput(['readonly' => true]) ?></div>
                    <div class="col-md-4"><?= $form->field($model, 'std_family')->textInput(['readonly' => true]) ?></div>
                    <div class="col-md-4"><?= $form->field($model, 'std_education')->textInput(['readonly' => true]) ?></div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
